...
import com.liublog.blog.strategy.context.ArticleImportStrategyContext;
...
import static com.liublog.blog.constant.OptTypeConst.*;
...
public class ArticleController {
    ...
    public Result<ArticleDTO> getArticleById(@PathVariable("articleId") Integer articleId) {
        return Result.ok(articleService.getArticleByIds(articleId));
    }
