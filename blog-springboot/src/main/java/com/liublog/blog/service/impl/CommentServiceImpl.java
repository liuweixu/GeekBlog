...
import com.liublog.blog.service.CommentService;
...
import static com.liublog.blog.enums.CommentTypeEnum.*;
...
public class CommentServiceImpl extends ServiceImpl<CommentDao, Comment> implements CommentService {
    ...
    @Override
    public void saveCommentLike(Integer commentId, HttpServletRequest request) {
        String sessionId = request.getSession().getId();
        System.out.println(sessionId);
        // 判断是否点赞
        String commentLikeKey = RedisPrefixConst.COMMENT_USER_LIKE + sessionId;
