...
CREATE TABLE `tb_article`  (
  ...
  `file_attach` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '未知',
...
) ENGINE = InnoDB AUTO_INCREMENT = 866 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_article_tag
-- ----------------------------
INSERT INTO `tb_article_tag` VALUES (865, 57, 29);
...
CREATE TABLE `tb_operation_log`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1135 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
-- Records of tb_page
-- ----------------------------
INSERT INTO `tb_page` VALUES (1, '首页', 'home', '\"\"', '2023-10-03 18:02:16', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (2, '归档', 'archive', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (3, '分类', 'category', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (4, '标签', 'tag', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (5, '相册', 'album', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (6, '友链', 'link', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (7, '关于', 'about', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (8, '留言', 'message', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (9, '个人中心', 'user', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (10, '文章列表', 'articleList', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
INSERT INTO `tb_page` VALUES (11, '说说', 'talk', '\"\"', '2023-10-01 19:12:21', '2023-10-01 19:12:21');
...
-- ----------------------------
INSERT INTO `tb_unique_view` VALUES (534, 1, '2023-10-01 00:00:00', NULL);
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, 'test@163.com', '$2a$10$UwNtV7nZPo5MM0uC6lTJrez6EnDH5VoFK1QkSAPsEQVbkQKozG3Xy', 1, '127.0.0.1', '', '2023-09-20 15:43:18', '2023-10-03 18:04:05', '2023-10-03 18:04:05');
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (1, 'test@163.com', '管理员', 'https://ts1.cn.mm.bing.net/th/id/R-C.59bceb337cc052f02c2e7d32bbadef2c?rik=uFV%2bZu%2beYPFBRg&riu=http%3a%2f%2fimg.sj33.cn%2fuploads%2fallimg%2f200912%2f20091223150228509.jpg&ehk=mzfRVDFqYW4BvWA6BxTa63nDZjlLRTumgV62WVyBzUA%3d&risl=&pid=ImgRaw&r=0', '', NULL, 0, '2023-09-27 15:43:17', '2023-10-03 17:27:26');
...
-- ----------------------------
INSERT INTO `tb_user_role` VALUES (1005, 1006, 2);
INSERT INTO `tb_user_role` VALUES (1006, 1007, 2);
INSERT INTO `tb_user_role` VALUES (1007, 1, 1);
...
-- ----------------------------
INSERT INTO `tb_website_config` VALUES (1, '{\"alipayQRCode\":\"\",\"articleCover\":\"https://ts1.cn.mm.bing.net/th/id/R-C.df4462fabf18edd07195679a5f8a37e5?rik=FnNvr9jWWjHCVQ&riu=http%3a%2f%2fseopic.699pic.com%2fphoto%2f50059%2f8720.jpg_wh1200.jpg&ehk=ofb4q76uCls2S07aIlc8%2bab3H5zwrmj%2bhqiZ%2fyw3Ghw%3d&risl=&pid=ImgRaw&r=0\",\"gitee\":\"\",\"github\":\"\",\"isChatRoom\":0,\"isCommentReview\":0,\"isEmailNotice\":1,\"isMessageReview\":0,\"isMusicPlayer\":0,\"isReward\":1,\"qq\":\"\",\"socialLoginList\":[],\"socialUrlList\":[\"gitee\"],\"touristAvatar\":\"https://img.zcool.cn/community/01f6dc5a74149ba80120a12366a277.jpg@1280w_1l_2o_100sh.jpg\",\"userAvatar\":\"https://img.zcool.cn/community/01f6dc5a74149ba80120a12366a277.jpg@1280w_1l_2o_100sh.jpg\",\"websiteAuthor\":\"\",\"websiteAvatar\":\"https://img.zcool.cn/community/01f6dc5a74149ba80120a12366a277.jpg@1280w_1l_2o_100sh.jpg\",\"websiteCreateTime\":\"2026-06-08\",\"websiteIntro\":\"\",\"websiteName\":\"\",\"websiteNotice\":\"\",\"websiteRecordNo\":\"\",\"websocketUrl\":\"\",\"weiXinQRCode\":\"\"}', '2021-08-09 19:37:30', '2023-10-03 17:36:59');
