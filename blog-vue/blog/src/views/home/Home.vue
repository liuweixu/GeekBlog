...
<!--            </div>-->
          ...
          <v-card class="blog-card animated zoomIn mt-5 big">
            ...
            <div class="guanzhu" id="follow-us" ref="follow">
              <ul>
                <li v-if="isShowSocial('gitee')" class="cnblogs">
                  <a href="https://www.cnblogs.com/Weixu-Liu/">
                      PJCK的博客（博客园）
                  </a>
...
.guanzhu .cnblogs{
    background: url(cnblogs.jpg) no-repeat;
